(function(){
  ...
  d3.json("../Patterns_data/" + traceId, function(error, allData) {
    ...
    function renderBars () {
      ...
      chart.selectAll(".bar")
        ...
        .enter().append("rect")
          ...
          .attr("fill", function(d){return colorPicker.GetColor(d.Count);})
          .on("mouseover", function(d) {      
                div.transition()        
                    .duration(200)      
                    .style("opacity", .9);      
                div .html( "Count: " + d.Count + "<br/>From: " + d.From+ "<br/>To: " + d.To)  
